...
import { extraElementsDb } from '@/lib/supabase/database'
...
export async function GET(request: NextRequest) {
  try {
    ...
    if (!supabase) {
      const all = await extraElementsDb.getAll()
...
export async function POST(request: NextRequest) {
  try {
    ...
    const supabase = createSupabaseAdmin()
    if (!supabase) {
      const element = await extraElementsDb.create({
        type,
        name,
        description,
        category,
...
export async function PATCH(request: NextRequest) {
  try {
    ...
    const supabase = createSupabaseAdmin()
    if (!supabase) {
      const element = await extraElementsDb.update(id, updates)
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    const supabase = createSupabaseAdmin()
    if (!supabase) {
      await extraElementsDb.delete(id)
